    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body py-4 px-5" style="background: linear-gradient(90deg,#e0e7ef 0%, #ffffff 100%); border-radius: 18px; box-shadow: 0 2px 16px rgba(0,0,0,0.06);">
                            <div class="text-left">
                                <h1 class="mb-2" style="font-weight: 800; font-size: 2.1rem; letter-spacing: 1px; color: #1a233a; text-shadow: 0 2px 8px rgba(0,0,0,0.06);">
                                    SISTEM INFORMASI MANAJEMEN DATA <span style='color:#1abc9c;'>(SIMDA)</span>
                                </h1>
                                <div style="font-size: 1.3rem; color: #4b5563; font-weight: 700; letter-spacing: 1.5px; text-transform: uppercase; margin-top: -6px;">
                                    Kabupaten Purworejo
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $value->nama_barang_pengajuan ?></td>
